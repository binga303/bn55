        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              {/* Warning Banner */}
              <div className="bg-[#104008] border-l-4 border-accent p-6 mb-8 rounded-r-lg">
              ...
              <div className="space-y-6 text-gray-300">
                ...
                <div className="bg-[#104008] rounded-xl p-6 border border-red-200">
                ...
                <div className="bg-[#104008] rounded-xl p-6 border border-blue-200">
